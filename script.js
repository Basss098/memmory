...
let d=[];
for(let i=0;i<220;i++){
  d.push({x:Math.random()*innerWidth,y:Math.random()*innerHeight,l:10+Math.random()*20,s:4+Math.random()*5});
}
function draw(){
